...
from finx.cli import main, tax_status_command, tax_missing_command, tax_update_dates_command, invest_command
import sys
import logging
...
class TestCLI(TestCase):
    ...
    def test_cli_tax_zip(self):
        ...
        with patch('sys.argv', ['finx', 'tax', 'zip', '--year', '2023']):
            with patch('finx.cli.create_zip_archive') as mock_zip_creator:
    ...
    def test_cli_with_no_command(self):
        ...
        with patch('sys.argv', ['finx']):
            ...
            with patch('finx.cli.parse_args') as mock_parse_args:
